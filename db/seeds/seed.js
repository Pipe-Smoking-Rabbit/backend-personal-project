...
const seed = async (data) => {
  ...
  const insertCategoriesQueryStr = format(
    "INSERT INTO categories (slug, description, category_img_url) VALUES %L RETURNING *;",
    categoryData.map(({ slug, description, category_img_url }) => [slug, description, category_img_url])
  );
